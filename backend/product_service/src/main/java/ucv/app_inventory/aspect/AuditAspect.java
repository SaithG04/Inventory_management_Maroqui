...
import ucv.app_inventory.adapters.outbounds.UserClient;
import ucv.app_inventory.audit.AuditService;
...
public class AuditAspect {
    ...
    public AuditAspect(AuditService auditService, UserClient userClient) {
    ...
    public Long getAuthenticatedUser() {
        ...
        return userClient.getUserByEmail(email).getData().getIdUser();
    }
     ...
     */
    @AfterReturning(value = "execution(* ucv.app_inventory.application.services.*.create*(..)) && !execution(* ucv.app_inventory.application.services.ProductApplicationService.create*(..)) && !execution(* ucv.app_inventory.application.services.CategoryApplicationService.create*(..))", returning = "result")
     ...
     */
    @AfterReturning(value = "execution(* ucv.app_inventory.application.services.*.update*(..)) && !execution(* ucv.app_inventory.application.services.ProductApplicationService.update*(..)) && !execution(* ucv.app_inventory.application.services.CategoryApplicationService.update*(..))", returning = "result")
     ...
     */
    @Before("execution(* ucv.app_inventory.application.services.*.delete*(..)) && !execution(* ucv.app_inventory.application.services.ProductApplicationService.delete*(..)) && !execution(* ucv.app_inventory.application.services.CategoryApplicationService.delete*(..))")
