...
public class OrderController {
    ...
    public ResponseEntity<ApiResponse<Page<OrderDTO>>> findAll(final Pageable pageable) {
        try {
            ...
            ApiResponse<Page<OrderDTO>> response = new ApiResponse<>(HttpStatus.CONFLICT.value(), e.getMessage());
    ...
    public ResponseEntity<ApiResponse<OrderDTO>> findById(
        ...
        try {
            // Attempt to find the orderCreateDTO by its ID using the modified use case method that throws an exception if not found
            OrderDTO orderCreateDTO = orderFindUseCase.findById(id);

            // Return the found orderCreateDTO with a 200 OK response
            ...
            ApiResponse<OrderDTO> response = new ApiResponse<>(HttpStatus.CONFLICT.value(), e.getMessage());
            return ResponseEntity.status(HttpStatus.CONFLICT).body(response);
        } catch (InvalidArgumentException e){
    ...
    public ResponseEntity<ApiResponse<OrderDTO>> updateOrder(
        ...
        try {
            ...
            ApiResponse<OrderDTO> response = new ApiResponse<>(HttpStatus.OK.value(), "Order updated successfully.");
    ...
    public ResponseEntity<ApiResponse<Void>> deleteOrder(
        ...
        try {
            ...
            ApiResponse<Void> response = new ApiResponse<>(HttpStatus.OK.value(), "Order deleted successfully.");
