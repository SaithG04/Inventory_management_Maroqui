...
public class GlobalExceptionHandler {
    ...
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    public ResponseEntity<String> handleTotalCannotBeNullException(TotalCannotBeNullException ex) {
        return ResponseEntity.badRequest().body("El total no puede ser nulo.");
    }
